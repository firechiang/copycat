 ...
 */
public class Activity05LauchMode01 extends AppCompatActivity {

    public Activity05LauchMode01() {
        Log.e("TAG","Activity05LauchMode01被创建了");
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity05_lauch_mode01);
    }
    ...
    public void start2(View view) {
        this.startActivity(new Intent(this,Activity05LauchMode02.class));
    }
