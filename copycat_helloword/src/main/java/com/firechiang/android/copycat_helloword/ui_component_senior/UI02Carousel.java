 ...
 * 轮播简单实现
 */
public class UI02Carousel extends AppCompatActivity {

    private static final String TAG = UI02Carousel.class.getSimpleName();
    ...
    private final int[] imageIds = {
            R.mipmap.app_carousel_a,
            R.mipmap.app_carousel_b,
            R.mipmap.app_carousel_c,
            R.mipmap.app_carousel_d,
            R.mipmap.app_carousel_e };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_comsenior02_carousel);
        viewpager = (ViewPager) findViewById(R.id.ui_comsenior02_carousel_viewpager);
        tv_title = (TextView) findViewById(R.id.ui_comsenior02_carousel_tv_title);
        ll_point_group = (LinearLayout) findViewById(R.id.ui_comsenior02_carousel_ll_point_group);
        ...
        for (int i = 0 ;i < imageIds.length;i++) {
            ...
            point.setBackgroundResource(R.drawable.carousel_point_selector);
...
//                            handler.sendEmptyMessageDelayed(0,4000);
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(UI02Carousel.this, "text=="+text, Toast.LENGTH_SHORT).show();
