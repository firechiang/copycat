 ...
 * 水波纹视图
 */
public class UI09WaterRippleView extends View {
    ...
    public UI09WaterRippleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        wList = new ArrayList<UI09WaterRippleView.Wave>();
    }
