 ...
 */
public class Activity05LauchMode03 extends Activity {

    public Activity05LauchMode03() {
        Log.e("TAG","Activity05LauchMode03被创建了");
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity05_lauch_mode03);
    }
