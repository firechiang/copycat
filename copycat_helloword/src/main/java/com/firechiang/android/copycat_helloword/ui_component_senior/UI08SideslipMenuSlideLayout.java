 ...
 * 侧滑菜单视图
 */
public class UI08SideslipMenuSlideLayout extends FrameLayout {

    private static final String TAG = UI08SideslipMenuSlideLayout.class.getSimpleName();
    ...
    public UI08SideslipMenuSlideLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        contentWidth = getMeasuredWidth();
    ...
    public interface OnStateChangeListenter{
        void onClose(UI08SideslipMenuSlideLayout layout);
        void onDown(UI08SideslipMenuSlideLayout layout);
        void onOpen(UI08SideslipMenuSlideLayout layout);
    }
